              ...
              {publishLoading && !publishResult ? (
                ...
                <div className="flex flex-1 items-center justify-center px-6 py-16">
                  <div className="flex flex-col items-center gap-4 text-sm text-gray-500">
                    <svg className="h-10 w-10 animate-spin text-gray-400" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                      <circle cx="12" cy="12" r="10" className="opacity-20" stroke="currentColor" strokeWidth="2.5" />
                      <path
                    ...
                    <span className="text-[13px] tracking-wide">Loading draft preview...</span>
                  </div>
                </div>
              )}
              </div>
